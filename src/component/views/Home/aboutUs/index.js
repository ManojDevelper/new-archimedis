      ...
      <div className='about-us'>
        ...
        <div className='aboutus-bottom'>
          <Row style={{ display: 'flex', alignItems: 'center', position: 'relative' }}>
            {/* case studies popup */}
            <Col className='aboutus-bottom-casestudy' span={hide ? 0 : 11}>
              <div style={{ backgroundColor: '#ffffff', padding: '5px 50px 20px 40px' }}>
                ...
                <h3 style={{ margin: '12px 0 0px', fontWeight: 'bold' }}>
            ...
            {/* why us text */}
            <Col className='aboutus-bottom-whyus' span={hide ? 11 : 10} style={{ padding: '0 66px' }}>
              <h1>Why us</h1>
              <p className='aboutus-text'>We operate at the intersection of Digital and Life SciencesWe operate at the intersection of Digital and Life SciencesMedical DevicesCROs & Supply-ChainDigital Health  ProductsMedical ResearchDigital Health  ProductsPharma &Bio TechLife Sciences SaaSPharma & Bio TechCROs & Supply-ChainMedical DevicesLife Sciences SaaS</p>
              <ButtonCompo text="Know More" type="bg-blue-border-black-txt" onClickHandle={() => setHide(!hide)}/>
            </Col>
            {/* test popup */}
            <Col className='aboutus-bottom-advantages' span={hide ? 12 : 0}>
              <div className='aboutus-bottom-advantages-content' style={{margin: '20px 0'}}>
                <img className='close-btn' src={closeBtn} alt="closeBtn" onClick={() => setHide(!hide)}/>
                <h2>
          ...
          {/* <Row style={{
            display: 'flex', alignItems: 'center', paddingTop: '45px',
            paddingBottom: '31px'
          }}>
